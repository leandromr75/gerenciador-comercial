...
namespace Gerenciador_Comercial
{
    public partial class CadastroProdutos : Form
    {
        ...
        public void abrirRegistro(DataTable produtos) 
        {
            if (produtos.Rows.Count > 0)
            {
                ...
                if (String.IsNullOrEmpty(Convert.ToString(produtos.Rows[0]["DataCadastro"].ToString())) == false)
                {
                    ...
                    label94.Text = Convert.ToString(produtos.Rows[0]["DataCadastro"].ToString());
        ...
        public void inicializaNovoRegistro()
        {
            ...
            radioButton1.Checked = true;
            textBox17.Text = "1";
            label94.Text = Convert.ToString( DateTime.Now );
        ...
        {
            if (panel10.Width >= 1260 || panel9.Width >= 1260)
            {
                tabControl2.SelectedTab = tabPage3;
                return;
        ...
        private void pictureBox2_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("É neceesarário salvar o cadastro que está sendo editado");
                return;
            }
            if (label92.Text == "não finalizado")
            {
                MessageBox.Show("É neceesarário salvar o cadastro");
                return;
            }
            if (panel10.Width >= 1260 || panel9.Width >= 1260)
            {
            ...
            while (panel9.Width < 1260)
            {
                Application.UseWaitCursor = true;
                panel9.Width = panel9.Width + 40;
            ...
            textBox37.Text = "";
            if (Global.Margem.Reload.ToString() == "Sim")
            {
                dataGridView3.DataSource = DALCadastro.listaProdutosTodos();
        ...
        private void pictureBox1_Click(object sender, EventArgs e)
        {
            ...
            dataGridView2.DataSource = DALCadastro.apagaXML_OK();
            string codEAN1;
            for (int i = 0; i < dataGridView1.Rows.Count; ++i)
            {
                codEAN1 = Convert.ToString(DALCadastro.vincularXML(Convert.ToString(dataGridView1.Rows[i].Cells[2].Value)));
                if (String.IsNullOrEmpty(codEAN1) == true)
                {
                    DALCadastro.criarStatusXMLVinculado("__");
                    //dataGridView2.DataSource = DALCadastro.listaXML_OK();
                }
                if (String.IsNullOrEmpty(codEAN1) == false)
                {
                    DALCadastro.criarStatusXMLVinculado("OK");
                    //dataGridView2.DataSource = DALCadastro.listaXML_OK();
                }
            ...
            {
                if (Convert.ToString(dataGridView2.Rows[j].Cells[1].Value) == "__")
                {
                    codFornec = Convert.ToString(DALCadastro.vincularXMLCod(Convert.ToString(dataGridView1.Rows[j].Cells[0].Value)));

                    if (String.IsNullOrEmpty(codFornec) == false)
                    {
                        DALCadastro.alterarStatusXMLVinculado(Convert.ToInt32(dataGridView2.Rows[j].Cells[0].Value));
                        //dataGridView2.DataSource = DALCadastro.listaXML_OK();
                    }
                }
        ...
        private void pictureBox10_Click(object sender, EventArgs e)
        {
            if (label92.Text == "editando")
            {
                MessageBox.Show("Cadastro em edição!");
                return;   
            }
            if (String.IsNullOrEmpty(label92.Text) == true)
            {
                ...
                label94.Text = dateTimePicker1.Text;
                textBox38.Text = "";
            ...
            if (edita == false && label92.Text == "0")
                {
                    ...
                    if (label92.Text == "0" )
                    {
                        ...
                        DALCadastro.Cadastrar_Produto(/*1 Revisão*/ label92.Text , /*2 Código DNF*/ textBox1.Text, /*3 cod EAN*/ textBox9.Text,
                            ...
                            /*32 original*/itemOriginal, /*33 data cadastro*/label94.Text,
            ...
            if (edita == true)
            {
               ...
               /* if (String.IsNullOrEmpty(comboBox8.Text) == true)
                ...
                if (label92.Text == "editando" && edita == true)
                {
                    ...
                    {
                        MessageBox.Show("Campo Valor de compra em formato incorreto");
                        return;
                    }
        ...
        private void textBox9_Enter(object sender, EventArgs e)
        {
            ...
            label8.Font = new Font("Microsoft Sans Serif", 9.0F, FontStyle.Bold);
            ...
            if (String.IsNullOrEmpty(label92.Text) == true)
            {
                ...
                textBox9.BackColor = System.Drawing.Color.White;
                pictureBox37.Visible = false;
                label8.Font = new Font("Microsoft Sans Serif", 9.0F, FontStyle.Regular);
                label8.BackColor = System.Drawing.Color.Transparent;
                return;
            }
        ...
        private void textBox3_Enter(object sender, EventArgs e)
        {
            ...
            label9.Font = new Font("Microsoft Sans Serif", 9.0F, FontStyle.Bold);
        ...
        private void button4_Click(object sender, EventArgs e)  
        {
            ...
            {
                MessageBox.Show("Não pode abrir arquivo XML sem terminar um lançamento pendente");
            }
            if (dataGridView1.Rows.Count == 0)
            {
                OpenFileDialog openFileDialog1 = new OpenFileDialog();
                ...
                if (openFileDialog1.ShowDialog() == System.Windows.Forms.DialogResult.OK)
                {
                    ...
                    foreach (XmlNode xn in xnList)
                    {
                        ...
                        DALCadastro.InserirXMLEstoque(codProd, descrição, codEAN, codEANTrib, qtde, und, valor);
        ...
        private void textBox22_Leave(object sender, EventArgs e)
        {
            textBox22.Text = textBox22.Text.Replace(".", ",");
            decimal dec1;
            if (Decimal.TryParse(textBox22.Text.Trim(), out dec1) == false)
            {
                MessageBox.Show("Insira somente valores numéricos");
                textBox22.Text = "";
                textBox22.Focus();
        ...
        private void textBox19_Leave(object sender, EventArgs e)
        {
            textBox19.Text = textBox19.Text.Replace(".", ",");
            decimal dec1;
            if (Decimal.TryParse(textBox19.Text.Trim(), out dec1) == false)
            {
                MessageBox.Show("Insira somente valores numéricos");
                textBox19.Text = "";
                textBox19.Focus();
        ...
        private void textBox1_Enter(object sender, EventArgs e)
        {
            ...
            label7.Font = new Font("Microsoft Sans Serif", 9.0F, FontStyle.Bold);
        ...
        private void pictureBox19_Click(object sender, EventArgs e)
        {
            ...
            if (String.IsNullOrEmpty(label92.Text) == false)
            {
                ...
                if (ncmCad.DialogResult == DialogResult.Cancel)
                {
                    ...
                    MessageBox.Show("Descrição do código NCM selecionado : \n\n" + Global.Margem.NCMTemp2);
        ...
        private void textBox6_Enter(object sender, EventArgs e)
        {
            ...
            label10.Font = new Font("Microsoft Sans Serif", 9.0F, FontStyle.Bold);
            ...
            if (String.IsNullOrEmpty(label92.Text) == true)
            {
                ...
                label10.Font = new Font(label110.Font, FontStyle.Regular);
        ...
        private void textBox5_Enter(object sender, EventArgs e)
        {
            ...
            label11.Font = new Font("Microsoft Sans Serif", 9.0F, FontStyle.Bold);
            ...
            if (String.IsNullOrEmpty(label92.Text) == true)
            {
                ...
                label11.Font = new Font("Microsoft Sans Serif", 9.0F, FontStyle.Regular);
        ...
        private void checkBox1_Enter(object sender, EventArgs e)
        {
            ...
            label12.Font = new Font("Microsoft Sans Serif", 9.0F, FontStyle.Bold);
            ...
            if (String.IsNullOrEmpty(label92.Text) == true)
            {
                ...
                label12.Font = new Font("Microsoft Sans Serif", 9.0F, FontStyle.Regular);
        ...
        private void textBox15_Enter(object sender, EventArgs e)
        {
            ...
            label19.Font = new Font("Microsoft Sans Serif", 9.0F, FontStyle.Bold);
            ...
            if (String.IsNullOrEmpty(label92.Text) == true)
            {
                ...
                label19.Font = new Font("Microsoft Sans Serif", 9.0F, FontStyle.Regular);
        ...
        private void textBox18_Enter(object sender, EventArgs e)
        {
            ...
            label22.Font = new Font("Microsoft Sans Serif", 9.0F, FontStyle.Bold);
            ...
            if (String.IsNullOrEmpty(label92.Text) == true)
            {
                ...
                label22.Font = new Font("Microsoft Sans Serif", 9.0F, FontStyle.Regular);
        ...
        private void textBox21_Enter(object sender, EventArgs e)
        {
            ...
            label25.Font = new Font("Microsoft Sans Serif", 9.0F, FontStyle.Bold);
            ...
            if (String.IsNullOrEmpty(label92.Text) == true)
            {
                ...
                label25.Font = new Font("Microsoft Sans Serif", 9.0F, FontStyle.Regular);
        ...
        private void textBox20_Enter(object sender, EventArgs e)
        {
            ...
            label26.Font = new Font("Microsoft Sans Serif", 9.0F, FontStyle.Bold);
            ...
            if (String.IsNullOrEmpty(label92.Text) == true)
            {
                ...
                label26.Font = new Font("Microsoft Sans Serif", 9.0F, FontStyle.Regular);
        ...
        private void textBox25_Leave(object sender, EventArgs e)
        {
            textBox25.Text = textBox25.Text.Replace(".", ",");
            decimal dec1;
            if (Decimal.TryParse(textBox25.Text.Trim(), out dec1) == false)
            {
                MessageBox.Show("Insira somente valores numéricos");
                textBox25.Text = "";
                textBox25.Focus();
        ...
        private void comboBox1_Click(object sender, EventArgs e)
        {
            ...
            label13.Font = new Font("Microsoft Sans Serif", 9.0F, FontStyle.Bold);
        ...
        private void comboBox1_Leave(object sender, EventArgs e)
        {
            ...
            label13.Font = new Font("Microsoft Sans Serif", 9.0F, FontStyle.Regular);
        ...
        private void comboBox2_Click(object sender, EventArgs e)
        {
            ...
            label14.Font = new Font("Microsoft Sans Serif", 9.0F, FontStyle.Bold);
        ...
        private void comboBox2_Leave(object sender, EventArgs e)
        {
            ...
            label14.Font = new Font("Microsoft Sans Serif", 9.0F, FontStyle.Regular);
        ...
        private void comboBox3_Click(object sender, EventArgs e)
        {
            ...
            label15.Font = new Font("Microsoft Sans Serif", 9.0F, FontStyle.Bold);
        ...
        private void comboBox3_Leave(object sender, EventArgs e)
        {
            ...
            label15.Font = new Font("Microsoft Sans Serif", 9.0F, FontStyle.Regular);
        ...
        private void comboBox4_Click(object sender, EventArgs e)
        {
            ...
            label16.Font = new Font("Microsoft Sans Serif", 9.0F, FontStyle.Bold);
        ...
        private void comboBox4_Leave(object sender, EventArgs e)
        {
            ...
            label16.Font = new Font("Microsoft Sans Serif", 9.0F, FontStyle.Regular);
        ...
        private void comboBox5_Click(object sender, EventArgs e)
        {
            ...
            label17.Font = new Font("Microsoft Sans Serif", 9.0F, FontStyle.Bold);
        ...
        private void comboBox5_Leave(object sender, EventArgs e)
        {
            ...
            label17.Font = new Font("Microsoft Sans Serif", 9.0F, FontStyle.Regular);
        ...
        private void comboBox6_Click(object sender, EventArgs e)
        {
            ...
            label20.Font = new Font("Microsoft Sans Serif", 9.0F, FontStyle.Bold);
        ...
        private void comboBox6_Leave(object sender, EventArgs e)
        {
            ...
            label20.Font = new Font("Microsoft Sans Serif", 9.0F, FontStyle.Regular);
        ...
        private void comboBox8_Click(object sender, EventArgs e)
        {
            ...
            label21.Font = new Font("Microsoft Sans Serif", 9.0F, FontStyle.Bold);
        ...
        private void comboBox8_Leave(object sender, EventArgs e)
        {
            ...
            label21.Font = new Font("Microsoft Sans Serif", 9.0F, FontStyle.Regular);
        ...
        private void comboBox9_Click(object sender, EventArgs e)
        {
            ...
            label23.Font = new Font("Microsoft Sans Serif", 9.0F, FontStyle.Bold);
        ...
        private void comboBox9_Leave(object sender, EventArgs e)
        {
            ...
            label23.Font = new Font("Microsoft Sans Serif", 9.0F, FontStyle.Regular);
        ...
        private void comboBox10_Click(object sender, EventArgs e)
        {
            ...
            label24.Font = new Font("Microsoft Sans Serif", 9.0F, FontStyle.Bold);
        ...
        private void comboBox10_Leave(object sender, EventArgs e)
        {
            ...
            label24.Font = new Font("Microsoft Sans Serif", 9.0F, FontStyle.Regular);
        ...
        private void comboBox11_Click(object sender, EventArgs e)
        {
            ...
            label27.Font = new Font("Microsoft Sans Serif", 9.0F, FontStyle.Bold);
        ...
        private void comboBox11_Leave(object sender, EventArgs e)
        {
            ...
            label27.Font = new Font("Microsoft Sans Serif", 9.0F, FontStyle.Regular);
        ...
        private void checkBox1_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (label92.Text == "editando")
            {
                if (checkBox1.Checked == true)
                {                    
                    string message = "Você deseja inativar este cadastro?";
                    string caption = "Inativo";
                    MessageBoxButtons buttons = MessageBoxButtons.YesNo;
                    DialogResult result;
                    result = MessageBox.Show(this, message, caption, buttons,
                    MessageBoxIcon.Question, MessageBoxDefaultButton.Button1);
                    if (result == DialogResult.Yes)
                    {
                        MessageBox.Show("Para concluir, clique em Salvar");
                        Global.Margem.Reload = "Sim";
                        if (Global.Margem.ConfiguraçãoSistemaLOGs == "sim")
                        {
        ...
        private void radioButton2_Click(object sender, EventArgs e)
        {
            ...
            {
                textBox29.Focus();
                MessageBox.Show("Favor entrar com comissão fixa");
            }
        }
        //|||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||
        //código para inicializar cadastro por XML|||||||||||||||||||||||||||
        //|||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||
        //||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||| 

        public void inicializaCadastroXML()
        {
        ...
        {
            if (String.IsNullOrEmpty(textBox35.Text) == true)
            {
                MessageBox.Show("Produto não selecionado");
                return;
            }
            if (textBox35.Text == "Cadastro não localizado.")
            {
                MessageBox.Show("Precisa cadastrar produto primeiro");
                return;
            }
            if (textBox35.Text == "Produto possui cadastro Prévio")
            {
               if (checkBox6.Checked == true && checkBox7.Checked == true)
                {
                    string message = "Esta operação irá movimentar o estoque e gerar contas a pagar. OK?";
                    string caption = "XML";
                    MessageBoxButtons buttons = MessageBoxButtons.YesNo;
                    DialogResult result;
            ...
            {
                string message = "Esta operação irá movimentar o estoque.\nEstoque atual : 123 PÇ . OK?";
                string caption = "XML";
                MessageBoxButtons buttons = MessageBoxButtons.YesNo;
                DialogResult result;
        ...
        {
                textBox34.Text = dataGridView1.Rows[dataGridView1.SelectedCells[0].RowIndex].Cells[1].FormattedValue.ToString();

                if (dataGridView2.Rows[dataGridView2.SelectedCells[0].RowIndex].Cells[1].FormattedValue.ToString() == "OK")
                {
                    textBox35.Text = "Produto possui cadastro Prévio";
                    if (String.IsNullOrEmpty(linhaCorreta) == true)
                    {
                        int linha = dataGridView1.CurrentRow.Index;
                        dataGridView2.CurrentCell = dataGridView2.Rows[linha].Cells[1];
                        linhaCorreta = "cheio";
                    }
                }

                if (dataGridView2.Rows[dataGridView2.SelectedCells[0].RowIndex].Cells[1].FormattedValue.ToString() == "__")
                {
                        textBox35.Text = "Cadastro não localizado.";
                        if (String.IsNullOrEmpty(linhaCorreta) == true)
                        {
                            int linha = dataGridView1.CurrentRow.Index;
                            dataGridView2.CurrentCell = dataGridView2.Rows[linha].Cells[1];
        ...
        {
            if (String.IsNullOrEmpty(textBox35.Text) == false )
            {
                int linha = dataGridView1.CurrentRow.Index;
                dataGridView2.CurrentCell = dataGridView2.Rows[linha].Cells[1];
        ...
        private void button13_Click(object sender, EventArgs e)
        {
            ...
            if (textBox35.Text == "Cadastro não localizado.")
            {
                MessageBox.Show("Produto sem cadastro Prévio");
                return;
            }
            if (String.IsNullOrEmpty(textBox35.Text) == true)
            {
        ...
        private void dataGridView3_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (dataGridView3.Rows.Count > 0)
            {
                ...
                textBox37.Text = dataGridView3.Rows[dataGridView3.SelectedCells[0].RowIndex].Cells[1].FormattedValue.ToString();
                //textBox37.Focus();
            }
            ...
            if (String.IsNullOrEmpty(textBox37.Text) == false)
            {
                ...
                if (String.IsNullOrEmpty(label93.Text) == true)
                {
                    if (dataGridView3.Rows.Count > 0)
                    {
                        ...
                        abrirRegistro(DALCadastro.listaProdutos(Convert.ToInt32(dataGridView3.Rows[dataGridView3.SelectedCells[0].RowIndex].Cells[0].FormattedValue.ToString())));
                        panel9.Width = 0;
                        return;
                    }
                ...
                if (String.IsNullOrEmpty(label93.Text) == false )
                {
                    int ident = Convert.ToInt32(dataGridView3.Rows[dataGridView3.SelectedCells[0].RowIndex].Cells[0].FormattedValue.ToString());
        ...
        {
            groupBox15.BackColor = System.Drawing.Color.Cyan;
        ...
        private void pictureBox59_Click(object sender, EventArgs e)
        {
            ...
            if (Convert.ToInt32(label92.Text) >= 1 )
            {
                ...
                //MessageBox.Show("Edição deste ítem ativada.\nNão esquecer de salvar registro após alterações.");
        ...
        private void button18_Click(object sender, EventArgs e)
        {
            if (checkBox9.Checked == true)
            {
                int mult = Convert.ToInt32(textBox27.Text);
                mult = mult + 1;
                textBox27.Text = Convert.ToString(mult);
            }
            if (checkBox10.Checked == true)
            {
                int mult = Convert.ToInt32(textBox27.Text);
        ...
        private void button20_Click(object sender, EventArgs e)
        {
            if (checkBox9.Checked == true)
            {
                int mult = Convert.ToInt32(textBox13.Text);
                mult = mult + 1;
                textBox13.Text = Convert.ToString(mult);
            }
            if (checkBox10.Checked == true)
            {
                int mult = Convert.ToInt32(textBox13.Text);
        ...
        private void button21_Click(object sender, EventArgs e)
        {
            if (checkBox9.Checked == true)
            {
                if (Convert.ToInt32(textBox26.Text) > 0)
                {
                    int mult = Convert.ToInt32(textBox26.Text);
                    mult = mult - 1;
                    if (mult >= 0)
                    {
                        textBox26.Text = Convert.ToString(mult);
                    }
                    if (mult < 0)
                    {
                        textBox26.Text = "0";
        ...
        {
            textBox32.BackColor = System.Drawing.Color.Cyan;
            pictureBox67.Visible = true;
            label41.Font = new Font("Microsoft Sans Serif", 9.0F, FontStyle.Bold);
            label41.ForeColor = System.Drawing.Color.Red;
            label41.BackColor = System.Drawing.Color.Cyan;
        ...
        {
            textBox31.BackColor = System.Drawing.Color.Cyan;
            pictureBox68.Visible = true;
            label40.Font = new Font("Microsoft Sans Serif", 9.0F, FontStyle.Bold);
            label40.ForeColor = System.Drawing.Color.Red;
            label40.BackColor = System.Drawing.Color.Cyan;
        }
        ...
        private void textBox31_Leave(object sender, EventArgs e)
        {
            ...
            label40.Font = new Font(label40.Font, FontStyle.Regular);
        ...
        {
            textBox30.BackColor = System.Drawing.Color.Cyan;
            pictureBox69.Visible = true;
            label39.Font = new Font("Microsoft Sans Serif", 9.0F, FontStyle.Bold);
            label39.ForeColor = System.Drawing.Color.Red;
            label39.BackColor = System.Drawing.Color.Cyan;
        }
        ...
        {
            textBox28.BackColor = System.Drawing.Color.Cyan;
            pictureBox71.Visible = true;
            label37.Font = new Font("Microsoft Sans Serif", 9.0F, FontStyle.Bold);
            label37.ForeColor = System.Drawing.Color.Red;
            label37.BackColor = System.Drawing.Color.Cyan;
        }
        ...
        private void comboBox12_Click(object sender, EventArgs e)
        {
            ...
            label38.Font = new Font("Microsoft Sans Serif", 9.0F, FontStyle.Bold);
            label38.ForeColor = System.Drawing.Color.Red;
            label38.BackColor = System.Drawing.Color.Cyan;
        }

        private void comboBox12_Leave(object sender, EventArgs e)
        {
            pictureBox70.Visible = false;
            label38.Font = new Font(label38.Font, FontStyle.Regular);
        ...
        {
            dataGridView3.DataSource = DALCadastro.ProcurarProdutoSemCodeBarDescInt("%" + textBox37.Text + "%");
            textBox37.Text = "";
        }
