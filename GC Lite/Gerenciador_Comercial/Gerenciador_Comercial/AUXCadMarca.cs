...
{
    public partial class AUXCadMarca : Form
    {
        public AUXCadMarca()
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (textBox1.ReadOnly == false && String.IsNullOrEmpty(textBox1.Text) == false )
            {
                ...
                if (jaexiste == false)
                {
                    string Stored = "CriarCadMarca";

                    DALCadastro.AUXCadCriar(Stored, textBox1.Text);
                    dataGridView1.DataSource = DALCadastro.AUXCadListar("ListarCadMarca");
        ...
        private void AUXCadMarca_Load(object sender, EventArgs e)
        {
            dataGridView1.DataSource = DALCadastro.AUXCadListar("ListarCadMarca");
        }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                string resul = Convert.ToString(DALCadastro.ProcuraAUXCad("ExcluiCadAUXMarca", textBox1.Text));
                ...
                if (String.IsNullOrEmpty(resul) == true)
                {
                    ...
                    {
                        DALCadastro.ExcluiCadAUX("ExcluiMarca", label3.Text);
                        dataGridView1.DataSource = DALCadastro.AUXCadListar("ListarCadMarca");
                    }
                }
            }
