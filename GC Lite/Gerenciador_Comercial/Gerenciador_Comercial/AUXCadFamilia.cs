...
using Gerenciador_Comercial;
namespace Gerenciador_Comercial
{
    public partial class AUXCadFamilia : Form
    {
        public AUXCadFamilia()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (textBox1.ReadOnly == false && String.IsNullOrEmpty(textBox1.Text) == false )
            {
                ...
                if (jaexiste == false)
                {
                    string Stored= "CriarCadFamilia";

                    DALCadastro.AUXCadCriar (Stored, textBox1.Text);
                    dataGridView1.DataSource = DALCadastro.AUXCadListar("ListarCadFamilia");
        ...
        private void AUXCadFamilia_Load(object sender, EventArgs e)
        {
            dataGridView1.DataSource = DALCadastro.AUXCadListar("ListarCadFamilia");
        }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                string resul = Convert.ToString(DALCadastro.ProcuraAUXCad("ExcluiCadAUXFamilia",textBox1.Text));
                ...
                if (String.IsNullOrEmpty(resul) == true)
                {
                    ...
                    {
                        DALCadastro.ExcluiCadAUX("ExcluiFamilia",label3.Text);
                        dataGridView1.DataSource = DALCadastro.AUXCadListar("ListarCadFamilia");
                    }
                }
            }
