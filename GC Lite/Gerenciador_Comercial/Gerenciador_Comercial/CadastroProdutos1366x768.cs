...
{
    public partial class CadastroProdutos1366x768 : Form
    {
        public CadastroProdutos1366x768()
        {
            InitializeComponent();
        }
        int contador = 0;
        ...
        public void inicializaNovoRegistro()
        {
            ...
            textBox8.Text = "0,00000";//valor de compra
            textBox12.Text = "0,00";//custo corrigido
            ...
            //comboBox8.Items.Clear();
            comboBox8.DataSource = DALCadastro.AUXCadListar("ListarCadNCM");
            comboBox8.ValueMember = "Descrição";
            comboBox8.DisplayMember = "Descricao";
            comboBox8.SelectedItem = "";
            comboBox8.Refresh();*/
            //comboBox1.SelectedIndex = comboBox1.FindStringExact("Produto Calórico");
            //fim
        ...
        private void CadastroProdutos1366x768_Load(object sender, EventArgs e)
        {
        ...
        private void pictureBox10_Click(object sender, EventArgs e)
        {
            ...
            if (String.IsNullOrEmpty(label92.Text) == true)
            {
                ...
                if (panel10.Width >= 1274 || panel1.Width >= 1274)
                {
                    tabControl2.SelectedTab = tabPage3;
                    return;
                ...
                //label67.Text = dateTimePicker1.Text;
                textBox38.Text = "";
        ...
        private void pictureBox2_Click(object sender, EventArgs e)
        {
            ...
            if (label92.Text == "editando")
            {
                MessageBox.Show("É necesarário salvar o cadastro que está sendo editado");
                return;
            }
        ...
        private void pictureBox8_Click(object sender, EventArgs e)
        {
            ...
            if (label92.Text == "não finalizado")
            {
               ...
               /* if (String.IsNullOrEmpty(comboBox6.Text) == true)
                ...
                textBox32.Focus();
                if (checkBox5.Checked == true && String.IsNullOrEmpty(textBox9.Text) == false)
                {
                    DataTable test = DALCadastro.ListaFracionadoAlternativo();
                    if (test.Rows.Count > 0)
                    {
                        for (int i = 0; i < test.Rows.Count; i++)
                        {
                            if (textBox9.Text == test.Rows[i]["Cod_Alternativo"].ToString())
                            {

                                MessageBox.Show("Este código da balança está cadastrado como alternativo\n no EAN : " 
                                    + test.Rows[i]["Cod_Principal"].ToString());
                                textBox9.Focus();
                                return;
                            }
                        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            finally
            {
                ...
                br.Close();
                fs.Close();
                MessageBox.Show("Imagem inserida com sucesso no banco de dados");
                button1.Visible = false;
                button2.Visible = false;
                button3.Visible = true;
                label108.Text = "";
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Não pode abrir XML sem terminar um lançamento");
            }
            if (dataGridView1.Rows.Count == 0)
            {
                OpenFileDialog openFileDialog1 = new OpenFileDialog();
        ...
        {
            if (checkBox8.Checked == true && String.IsNullOrEmpty(textBox37.Text) == false)
            {
